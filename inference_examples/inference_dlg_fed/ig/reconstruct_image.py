...
if __name__ == "__main__":
    ...
    setup = inference_examples.inference_dlg_fed.ig.inversefed.utils.system_startup(args, defs)
    ...
    if args.accumulation == 0:
        ...
        local_lr = 1e-4
        input_parameters = inference_examples.inference_dlg_fed.ig.inversefed.reconstruction_algorithms.loss_steps(model, ground_truth, labels,
    ...
    test_psnr = inference_examples.inference_dlg_fed.ig.inversefed.metrics.psnr(output, ground_truth, factor=1 / ds)
    ...
    inference_examples.inference_dlg_fed.ig.inversefed.utils.save_to_table(args.table_path, name=f'exp_{args.name}', dryrun=args.dryrun,
